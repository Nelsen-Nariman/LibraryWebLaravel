        ...
        <div class="content">
            ...
            <form action="{{ route('createBook') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="Input1" name="judulBuku" style="width: 100%;">
                </div>

                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label1">Penulis buku<br></label>
                    <input type="text" class="form-control" id="Input2" name="penulisBuku" style="width: 100%;">
                </div>

                <div class="mb-3">
                    <label for="Input3" class="form-label1">Jumlah halaman<br></label>
                    <input type="text" class="form-control" id="Input3" name="jumlahHalaman" style="width: 100%;">
                </div>

                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label1">Tahun terbit<br></label>
                    <input type="text" class="form-control" id="Input4" name="tahunTerbit" style="width: 100%;">
                </div>
